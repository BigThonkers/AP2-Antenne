...
\title{
	...
	\textbf{\LARGE 
		Spezial Versuch: Vermessung der Dipolcharakteristik einer Dipolantenne
	} \\[3mm]
	(durchgeführt am 6. März 2019 bei Assistent: Ramirez Diego) \\}
\author{Markus Österle, Jan-Philipp Maurer , Erik Bode, Damian Lanzenstiel\\ (Gruppe: 22/1111)}
\date{10. März 2019}
\maketitle
\tableofcontents
...
\section{Versuchsaufbau}
	Tag 1
	\begin{itemize}
		\item Antennen löten /drucken
		\item Installieren des HackRF
		\item Erste Funktionstests
	\end{itemize}
