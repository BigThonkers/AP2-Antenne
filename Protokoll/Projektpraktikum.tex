...
\section{Wichtige Abschnitte des Antennenbaus}
\textcolor{red}{Besserer Titel?}
\subsection{Antennenbau}
Hier eine Beschreibung des Aufbaus der alten Antennen: Link https://www.la1k.no/2017/10/25/a-quick-sleeve-metal-dipole-for-23-cm/
\textcolor{red}{Bild}

Jetzt der Aufbau von den neuen Antennen \textcolor{red}{Bild}
\textcolor{red}{Einfach aus "Versuchsa... ung" - Die Antennen kopieren?}

\subsection{Messung der Antennengüte}
Hier SWR Messung erklären \textcolor{red}{Bild Aufbau}

\subsection{Vergleich der Antennen}
Vergleich der Charakteristik alter und neuer Antennen. \textcolor{red}{Screenshot $\cancel{oder CSV}$}


\subsection{Trimmen der Empfangsantenne}
Wieso trimmen, wie trimmen
\textcolor{red}{Bild der getrimmten Antenne}

\subsection{Vergleich der Richtkoppler}
Die neuen haben fast nicht angezeigt. \textcolor{red}{Bild}
...
\textcolor{red}{Das sollte eher ein eigener Abschnitt werden, in etwa beide vergleichen}
